...
\begin{document}
    ...
    \subsection{Session 2: An introduction to Qiskit and to IBM's
...
\subsubsection{\texorpdfstring{\textbf{3. Executing
circuits}}{3. Executing circuits}}\label{executing-circuits}

    \textbf{Question:} Why does the histogram have only one bar
...
\prompt{Out}{outcolor}{60}{}
    ...
    \paragraph{\texorpdfstring{\textbf{4. Generation of truly random numbers
with a quantum
computer}}{4. Generation of truly random numbers with a quantum computer}}\label{generation-of-truly-random-numbers-with-a-quantum-computer}

    Question: Can you write in a piece of paper the initial state in the
...
\end{tcolorbox}
    ...
    Question: Write a loop that generates 32 random numbers and plot a
...
\PY{l+s+s1}{What we got        }\PY{l+s+si}{\PYZob{}}\PY{n}{result}\PY{l+s+si}{\PYZcb{}}
\PY{l+s+s1}{What we should get }\PY{l+s+si}{\PYZob{}}\PY{n}{expected}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{\PYZsq{}\PYZsq{}\PYZsq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
3-register QFT.} At the step at which we accomplish
...
\prompt{Out}{outcolor}{67}{}
    ...
    \textbf{Question 5.2} Write the state resulting from applying that
...
Please implement now the Quantum Fourier Transform as a gate acting over
